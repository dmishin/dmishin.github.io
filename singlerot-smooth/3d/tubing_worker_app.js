...
(function() {
  var CircularInterpolatingSimulator, Simulator, Tubing, boundingBox, nGonVertices, _ref;
  ...
  boundingBox = function(pattern) {
    var i, x, xmax, xmin, y, ymax, ymin, _i, _ref1, _ref2;
    if (pattern.length === 0) {
      return [0, 0, 0, 0];
    }
    xmin = xmax = pattern[0][0];
    ymin = ymax = pattern[0][1];
    for (i = _i = 1, _ref1 = pattern.length; _i < _ref1; i = _i += 1) {
  ...
  exports.Tubing = Tubing = (function() {
    function Tubing(pattern, options) {
      var cx, cy, i, interpSteps, order, simulator, smoothing, timeScale, x0, x1, y0, y1, _i, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      this.size = (_ref1 = options.size) != null ? _ref1 : 64;
      simulator = new Simulator(this.size, this.size);
      _ref2 = boundingBox(pattern), x0 = _ref2[0], y0 = _ref2[1], x1 = _ref2[2], y1 = _ref2[3];
      ...
      timeScale = (_ref5 = options.timeScale) != null ? _ref5 : 0.1;
      smoothing = (_ref6 = options.smoothingPeriod) != null ? _ref6 : 4;
      this.isim = new CircularInterpolatingSimulator(simulator, order, interpSteps, smoothing);
      this.skipSteps = (_ref7 = options.skipSteps) != null ? _ref7 : 1;
      this.chunkSize = (_ref8 = options.chunkSize) != null ? _ref8 : 500;
      this.stepZ = timeScale / interpSteps;
      this.nCells = pattern.length;
      this.jumpTreshold = 3;
      this.prevStates = null;
      this.tubeShape = nGonVertices((_ref9 = options.tubeSides) != null ? _ref9 : 3, (_ref10 = options.tubeRadius) != null ? _ref10 : 0.1);
      this.prevNormals = new Float32Array(this.nCells * 3);
      for (i = _i = 0, _ref11 = this.nCells * 3; _i < _ref11; i = _i += 3) {
