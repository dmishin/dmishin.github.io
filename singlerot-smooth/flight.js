...
// Generated by CoffeeScript 1.7.1
(function() {
  var CircularInterpolatingSimulator, Float32Array, Int8Array, Simulator, Transforms, addScaled, lanczosInterpolator, lanczosKernel, makeRule, mod, mod2, sinc, snap,
  ...
  exports.Simulator = Simulator = (function() {
    function Simulator(width, height, rule) {
      ...
      this.height = height;
      this.cells = [];
      this.field = new Int8Array(this.width * this.height);
      this.field1 = new Int8Array(this.width * this.height);
      this.phase = 0;
