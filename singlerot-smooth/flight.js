...
// Generated by CoffeeScript 1.7.1
(function() {
  var CircularInterpolatingSimulator, Float32Array, Int8Array, Simulator, Transforms, addScaled, fillZeros, lanczosInterpolator, lanczosKernel, makeRule, mod, mod2, newFloatArray, newInt8Array, sinc, snap,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __slice = [].slice;

  Int8Array = Int8Array != null ? Int8Array : Array;

  Float32Array = Float32Array != null ? Float32Array : Array;
  ...
  newInt8Array = Int8Array != null ? function(sz) {
    return new Int8Array(sz);
  } : function(sz) {
    return fillZeros(new Array(sz));
  };

  newFloatArray = Float32Array != null ? function(sz) {
    return new Float32Array(sz);
  } : function(sz) {
    return fillZeros(new Float32Array(sz));
  };
  ...
  exports.CircularInterpolatingSimulator = CircularInterpolatingSimulator = (function() {
    ...
    CircularInterpolatingSimulator.prototype._appendStateToBuffer = function(tail) {
      var newState, state;
      this.states = (function() {
